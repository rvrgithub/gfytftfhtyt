        ...
        setTimeout(async () => {
            ...
            if (data.status == "Allocated") {
                ...
                let message = {
                    ...
                    notification: {
                        title: "New Lead",
                        body: "You are getting a new lead .Plz check in your app",
                        sound: "default",
                ...
                await Leads.updateOne({ "userName": req.user.userName, "tasks.email": req.body.email }, { $set: { "status": "Not Interested", isDeleted: true } })
